...
- Explore the Linked Stage Graph performances using the [**Vikus Viewer**](https://slod.fiz-karlsruhe.de/)
- Latest Publication on Linked Stage Graph:  
T. Tietz, O. Bruns, H. Sack: [**A Data Model for Linked Stage Graph and the Historical Performing Arts Domain**](https://ceur-ws.org/Vol-3540/short1.pdf), In Proc. of the International Workshop on Semantic Web and Ontology Design for Cultural Heritage (SWODCH), co-located with ISWC 2023. CEUR WS Vol-3540 in Athens, Greece.
